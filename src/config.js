...
const Config = {
  ...
  initCodeHash:
    "6d3f89421f83e4b62e628de8fc7ff2b014a79bf8fd8e8b0ea46e4a1d9409b67d",
  sunUrl: "https://sun.io/",
  sun: {
...
if (env === "testPro") {
  ...
  devConfig = {
    ...
    initCodeHash:
      "9dd9bfc2f6c1103a6c01d9c6a4044e4b8a9361f92df2728cdc3729922d56748e",
    sun: {
      exchange: "TMW477jqeR1RWEVvmXJBhyRckmiTPxvKg9",
      sunLearnMoreEn:
        "https://sunio.zendesk.com/hc/en-us/articles/900006328246",
      sunLearnMoreCn:
        "https://sunio.zendesk.com/hc/zh-cn/articles/900006328246",
      oldSunDecimal: 18,
...
if (env === "qaTest") {
  devConfig = {
    ...
    swapService: "http://127.0.0.1:7788/swap",
    swapServiceV2: "http://47.252.23.81:10085/swapv2",
    remainTrx: 100,
    remainMaxTrx: 1200,
    firstTRXLimit: 10,
